...
while handle_interrupt() do
    ...
    draw(alpha(e(c + 0.0 + 0.25) * 0xcc+0x33))
    ...
    draw(alpha(e(c + 0.2 + 0.25) * 0xcc + 0x33))
    ...
    draw(alpha(e(c + 0.4 + 0.25) * 0xcc + 0x33))
    ...
    draw(alpha(e(c + 0.6 + 0.25) * 0xcc + 0x33))
    ...
    draw(alpha(e(c + 0.8 + 0.25) * 0xcc + 0x33))
    draw(color_rgb3(eas2 * 0xcc, eas3 * 0xcc, eas4 * 0xcc))
